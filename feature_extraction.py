...
get_ipython().run_cell_magic('time', '', "# Write training DataFrame to hdf5\ntrain.to_hdf('hdf5/train.h5', key='train', format='table', mode='w')\n")
